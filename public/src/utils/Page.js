        ...
        <div class="recorder_container hidden">
            ...
            <div class="recorded_element_container hidden">
                ...
                <div class="download_recorded_video_container">
                    <a role="button" class="download_recorded_video_button">${this.traduction.recorded.button.download}</a>
                    <button class="upload_recorded_video_button">
                        ${this.traduction.recorded.button.upload}
                ...
                <div class="recorded_message_upload hidden">
                    ...
                    <span class="complete hidden">${this.traduction.upload.complete}</span>
                    <span class="error hidden">${this.traduction.upload.error}</span>
                    <span class="connection hidden">${this.traduction.upload.noConnection}</span>
